...
/**
 * @see https://core.telegram.org/constructor/encryptedChatRequested
 * @codeCoverageIgnore
 */
final class EncryptedChatRequested implements EncryptedChatInterface
{
    public const ID = -931638658;
