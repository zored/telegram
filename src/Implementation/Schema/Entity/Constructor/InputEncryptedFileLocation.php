...
/**
 * @see https://core.telegram.org/constructor/inputEncryptedFileLocation
 * @codeCoverageIgnore
 */
final class InputEncryptedFileLocation implements InputFileLocationInterface
{
    public const ID = -182231723;
