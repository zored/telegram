...
/**
 * @see https://core.telegram.org/constructor/messageActionChatDeleteUser
 * @codeCoverageIgnore
 */
final class MessageActionChatDeleteUser implements MessageActionInterface
{
    public const ID = -1297179892;
