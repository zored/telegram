...
/**
 * @see https://core.telegram.org/constructor/updatesCombined
 * @codeCoverageIgnore
 */
final class UpdatesCombined implements UpdatesInterface
{
    public const ID = 1918567619;
     ...
     * @return IntInterface
     */
    public function getSeqStart(): IntInterface
    {
        return $this->seq_start;
    }

    public function setSeqStart(int $seq_start): self
    {
        $this->seq_start = new class($seq_start) extends AbstractBaseType implements IntInterface {
        };
