...
/**
 * @see https://core.telegram.org/constructor/updateEncryptedChatTyping
 * @codeCoverageIgnore
 */
final class UpdateEncryptedChatTyping implements UpdateInterface
{
    public const ID = 386986326;
