...
/**
 * @see https://core.telegram.org/constructor/inputAudioFileLocation
 * @codeCoverageIgnore
 */
final class InputAudioFileLocation implements InputFileLocationInterface
{
    public const ID = 1960591437;
