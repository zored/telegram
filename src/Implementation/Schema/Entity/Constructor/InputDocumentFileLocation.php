...
/**
 * @see https://core.telegram.org/constructor/inputDocumentFileLocation
 * @codeCoverageIgnore
 */
final class InputDocumentFileLocation implements InputFileLocationInterface
{
    public const ID = 1313188841;
