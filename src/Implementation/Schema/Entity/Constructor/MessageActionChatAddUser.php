...
/**
 * @see https://core.telegram.org/constructor/messageActionChatAddUser
 * @codeCoverageIgnore
 */
final class MessageActionChatAddUser implements MessageActionInterface
{
    public const ID = 1581055051;
